...
public class ApolloVersionPreferenceController extends BasePreferenceController {
    ...
    private static final String TAG = "apolloVersionDialogCtrl";
    private static final int DELAY_TIMER_MILLIS = 500;
    private static final int ACTIVITY_TRIGGER_COUNT = 3;

    private static final String KEY_APOLLO_VERSION_PROP = "ro.apollo.version";
    ...
    public CharSequence getSummary() {
        return SystemProperties.get(KEY_APOLLO_VERSION_PROP,
